...
describe('Plugin test', () => {
  ...
  describe('receiving events', () => {
    ...
    it('should be able to register all events without type-errors', () => {
      const plugin = new Plugin(new EventEmitter(), new EventsReceived(), new EventsSent(), dummyLogger);
      plugin.on('applicationDidLaunch', () => {});
      plugin.on('applicationDidTerminate', () => {});
      plugin.on('deviceDidConnect', () => {});
      plugin.on('deviceDidDisconnect', () => {});
      plugin.on('dialDown', () => {});
      plugin.on('dialPress', () => {});
      plugin.on('dialUp', () => {});
      plugin.on('dialRotate', () => {});
      plugin.on('didReceiveGlobalSettings', () => {});
      plugin.on('didReceiveSettings', () => {});
      plugin.on('keyDown', () => {});
      plugin.on('keyUp', () => {});
      plugin.on('propertyInspectorDidAppear', () => {});
      plugin.on('propertyInspectorDidDisappear', () => {});
      plugin.on('sendToPlugin', () => {});
      plugin.on('systemDidWakeUp', () => {});
      plugin.on('timerUpdate', () => {});
      plugin.on('titleParametersDidChange', () => {});
      plugin.on('touchTap', () => {});
      plugin.on('websocketOpen', () => {});
      plugin.on('willAppear', () => {});
      plugin.on('willDisappear', () => {});
    });
  });
});
